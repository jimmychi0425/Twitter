...
class APIManager: SessionManager {
    ...
    static let consumerKey = "61MTzeVxBtFCPgP22NzrXun8W"
    static let consumerSecret = "qEUZ0dWbeZLE0QrVUHUnovBvzUQZMbPLK2Pfdso8ixMlehwYsb"
...
//        }
    ...
    func un_favorite(_ tweet: Tweet, completion: @escaping (Tweet?, Error?) -> ()) {
